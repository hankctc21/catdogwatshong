...
public class ReviewService {
	...
	public Review write(ReviewDto.Write dto, String loginId) {
		...
		dto.getRattachments().forEach(uploadFile->{
			...
			review.setImageFileName(saveFileName);
			try {
			...
			review.addAttachment(new ReviewAttachment(0, null, uploadFile.getOriginalFilename(), saveFileName, uploadFile.getSize(), isImage));
		});
	...
	public Review read(Integer rno) {
